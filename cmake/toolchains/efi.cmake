...
set(CMAKE_C_LINK_EXECUTABLE "<CMAKE_LINKER> -flavor link <LINK_FLAGS> -subsystem:efi_application -entry:_start -nodefaultlib ${SHIRO_MIN_PREOBJECTS_COFF} <OBJECTS> <LINK_LIBRARIES> /out:<TARGET>")
...
set(CMAKE_ASM_NASM_LINK_EXECUTABLE "<CMAKE_LINKER> -flavor link <LINK_FLAGS> -subsystem:efi_application -entry:_start -nodefaultlib ${SHIRO_MIN_PREOBJECTS_COFF} <OBJECTS> <LINK_LIBRARIES> /out:<TARGET>")
